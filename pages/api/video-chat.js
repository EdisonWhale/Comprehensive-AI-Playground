...
let chain;
// Chat history is where we store each human/chatbot message.
let chatHistory = [];
...
const initializeChain = async (initialPrompt, transcript) => {
  try {
    ...
    // Create a text splitter,use a smaller chunk size and chunk overlap since we are working with small sentences
    ...
    // copy our root directory and save it as a variable
    const directory =
      "/Users/EdisonWhale/Desktop/openai-javascript-course-1-start-here/yt-content/";
    ...
    //  create vectorstore, which can be created from embeddings.
